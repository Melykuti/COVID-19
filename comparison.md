...
22 March 2020 (updated on 12 June 2021), Freiburg i. Br., Germany – There are different visualisations of the spread of the coronavirus pandemic. Many of them are more alarmist than insightful. My goal on this page is to present an innovation in how to look at the problem.
...
![Joint relative increments through time](https://github.com/Melykuti/COVID-19/blob/master/plots/Joint_DGR_2021-06-11_xy_7_mean_date_incr_confirmed.png)
...
![Joint relative increments against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Joint_DGR_2021-06-11_xy_7_mean_cases_incr_confirmed.png)

![Joint daily growth rates against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Joint_DGR_2021-06-11_xy_-1_lin_cases_rate_confirmed.png)
...
![Daily relative increments for China, EU, USA, Russia, Brazil and India through time](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2021-06-11_xy_7_mean_date_incr_confirmed.png)

![Daily relative increments for China, EU, USA, Russia, Brazil and India against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2021-06-11_xy_7_mean_cases_incr_confirmed.png)

![Daily growth rates for China, EU, USA, Russia, Brazil and India against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2021-06-11_xy_-1_lin_cases_rate_confirmed.png)
...
![Daily relative increments for East Europe through time](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2021-06-11_xy_7_mean_date_incr_confirmed.png)

In San Marino, there are some 34,000 inhabitants. Iceland has got about 350,000.

![Daily relative increments for East Europe against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2021-06-11_xy_7_mean_cases_incr_confirmed.png)

![Daily growth rates for East Europe against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2021-06-11_xy_-1_lin_cases_rate_confirmed.png)
