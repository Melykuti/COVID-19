...
22 March 2020 (updated on 24 April 2020), Freiburg i. Br., Germany -- There are different visualisations of the spread of the coronavirus pandemic mushrooming on the internet. Many of them are more alarmist than insightful. My goal on this page is to present an innovation in how to look at the problem.
...
![Joint relative increments against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Joint_DGR_2020-04-23_xy_-1_exp_cases_incr_confirmed.png)
...
![Joint daily growth rates against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Joint_DGR_2020-04-23_xy_-1_exp_cases_rate_confirmed.png)
...
![Daily relative increments for China, EU, USA through time](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2020-04-23_xy_-1_exp_date_incr_confirmed.png)

![Daily relative increments for China, EU, USA against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2020-04-23_xy_-1_exp_cases_incr_confirmed.png)

![Daily growth rates for China, EU, USA against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/great_powers_DGR_2020-04-23_xy_-1_exp_cases_rate_confirmed.png)


#### The Visegrád Group (Poland, Czech Republic, Slovakia, Hungary) and some small countries

In this block there are East European countries. There is Iceland, which has a rather high infection rate. This is more due to broad testing than to a comparatively bad situation. As far as I know, Iceland tests even random selected members of the population who do not show any symptoms to get a clearer idea of the extent of infections. San Marino, being in Italy, is a proxy for the North Italian situation as its case numbers are from a small, concentrated region. The trajectories of Italy and Spain are included for comparison. Serbia did not report new cases on 21, 22 and 23 April which I suspect is an error of the data feed and not a reflection of reality.

![Daily relative increments for East Europe through time](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2020-04-23_xy_-1_exp_date_incr_confirmed.png)
...
![Daily relative increments for East Europe against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2020-04-23_xy_-1_exp_cases_incr_confirmed.png)
...
![Daily growth rates for East Europe against relative numbers](https://github.com/Melykuti/COVID-19/blob/master/plots/Visegrad_DGR_2020-04-23_xy_-1_exp_cases_rate_confirmed.png)
